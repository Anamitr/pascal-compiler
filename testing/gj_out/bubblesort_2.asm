...
czytajtab:
        ...
        mov.i   #2,BP-4                 ;mov.i   2,i
lab2:
        jl.i    BP-4,#12,#lab3          ;jl.i    i,12,lab3
...
lab4:
        ...
        sub.i   BP-4,#2,BP-12           ;sub.i   i,2,$t1
...
bubblesort:
        ...
        mov.i   #2,BP-4                 ;mov.i   2,i
lab6:
        jl.i    BP-4,#12,#lab7          ;jl.i    i,12,lab7
...
lab10:
        jl.i    BP-8,#12,#lab11         ;jl.i    j,12,lab11
...
lab14:
        ...
        sub.i   BP-4,#2,BP-52           ;sub.i   i,2,$t12
...
wypisztab:
        ...
        mov.i   #2,BP-4                 ;mov.i   2,i
lab18:
        jl.i    BP-4,#12,#lab19         ;jl.i    i,12,lab19
...
lab20:
        ...
        sub.i   BP-4,#2,BP-12           ;sub.i   i,2,$t25
